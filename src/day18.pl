...
coordinate(P, Vs1, Vs2, Ix1, Ix2, Q1, Q2, Ac, R) :-
  nextState(P, Ix1, Vs1, Q1, NIx1, NVs1, NQ1, S1),
  nextState(P, Ix2, Vs2, Q2, NIx2, NVs2, NQ2, S2),
  ( (Ix1 = NIx1, Ix2 = NIx2) -> R is Ac ;
    (S1 = 'nil' -> FQ2 = NQ2 ; append(NQ2, [S1], FQ2)),
    (S2 = 'nil' -> FQ1 = NQ1, NAc = Ac ; append(NQ1, [S2], FQ1), NAc is Ac+1),
    coordinate(P, NVs1, NVs2, NIx1, NIx2, FQ1, FQ2, NAc, R)).
