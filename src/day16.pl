...
partner([H|T], A, B, X, Ys) :- partner(T, A, B, X, Ys1), Ys = [H|Ys1], !.
partner([A|T], A, B, 0, Ys) :- partner(T, A, B, 1, Ys1), Ys = [B|Ys1], !.
partner([B|T], A, B, 0, Ys) :- partner(T, A, B, 1, Ys1), Ys = [A|Ys1], !.
partner([A|T], A, B, 1, Ys) :- Ys = [B|T], !.
partner([B|T], A, B, 1, Ys) :- Ys = [A|T], !.
